...
export function registerGetContentDetail(server, dataService) {
    server.tool('get_content_detail', 'Get detailed information about a specific drama, movie, variety show, or anime on WeTV/Tencent Video (腾讯视频). Returns full details including synopsis, cast, rating, episode count, update schedule, play links, and available regions/subtitles.', {
...
//# sourceMappingURL=get-content-detail.js.map