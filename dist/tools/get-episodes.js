 ...
 */
import { z } from 'zod';
export function registerGetEpisodes(server, dataService) {
    server.tool('get_episodes', 'Get the episode list for a specific drama, anime, or variety show on WeTV/Tencent Video. Returns episode numbers, names, durations, air dates, and play links with subtitle information.', {
...
//# sourceMappingURL=get-episodes.js.map